/**
 * Class representing a GetAllBlogQuery query
 */
  ...
  * @param {string} userId The id of the user to find the Blog for
  */
  ...
  * @param {string} tagId The id of the tag to find the Blog for
  */
