...
@Injectable()
export class userAtherization {
  //constructor(private prisma: PrismaService) {}

  async findUserAtherization(@Param() id:string,userPermissions:user_permissions,rolePermissions:role_permission):Promise<authorizationStudent> {
