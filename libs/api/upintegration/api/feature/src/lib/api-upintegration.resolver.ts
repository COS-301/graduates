...
export class ApiUpIntegrationResolver {
  constructor(private Service: ApiUpIntegrationService) {}
  ...
  async getAcademicRecord(): Promise<AcademicRecord> {
    ...
    details.fileAsString =
      'stub for future use, use the Storage api for retrieving and uploading academic records to the database';
  ...
  async getDegree(): Promise<Degree> {
    ...
    details.fileAsString =
      'stub for future use, use the Storage api for retrieving and uploading degree to the database';
