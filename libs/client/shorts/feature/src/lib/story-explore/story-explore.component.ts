...
export class StoryExploreComponent implements OnInit {
  ...
  cardlist = [
    { username: 'Username' ,pk: 0, pic: '', tags: ["#COS301", "#TAGTest", "#to_take_space"]}
  ];
  ...
  loadCards(){
    ...
    for (let index = 1; index < 6; index++) {
      this.cardlist.push({ username: 'User '+index.toString(), pk: index, pic: 'data:image/jpeg;base64,', tags: [ "#to_take_space", "#to_take_space","#COS301", "#TAGTest", "#to_take_space"]});
